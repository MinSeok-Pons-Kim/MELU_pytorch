#CUDA_VISIBLE_DEVICES=1 python maml.py --seed 2 --model_name PD  --rerun &
...
#CUDA_VISIBLE_DEVICES=1 python maml.py --test --test_way old_user --seed 2 --test --test_way old_user &
